...
void main()
{
    SetMerchantItem(1, "Torch", "nw_it_torch001", 2, COIN_COPPER);
    SetMerchantItem(2, "Iron Spike", "crpi_ironspikes", 5, COIN_COPPER);
    ...
    SetMerchantItem(8, "Burlap Tent", "crpi_adv_tent02", 15, COIN_SILVER);
}
