...
void main()
{
    ...
    if(nEssence == 1055)     {eCone = EffectVisualEffect(VFX_BEAM_EVIL);}
    else if(nEssence == 1056){eCone = EffectVisualEffect(1547);}
    else if(nEssence == 1057){eCone = EffectVisualEffect(1548);}
    else if(nEssence == 1058){eCone = EffectVisualEffect(1546);}
    else if(nEssence == 1059){eCone = EffectVisualEffect(1554);}
    else if(nEssence == 1060){eCone = EffectVisualEffect(1551);}
    else if(nEssence == 1061){eCone = EffectVisualEffect(1592);}
    else if(nEssence == 1062){eCone = EffectVisualEffect(1555);}
    else                     {eCone = EffectVisualEffect(1552);}

    ApplyEffectToObject(DURATION_TYPE_INSTANT,eCone,oPC);
    ...
    oTarget = GetFirstObjectInShape(SHAPE_SPELLCONE, 11.0, lTargetLocation, TRUE, OBJECT_TYPE_CREATURE);
