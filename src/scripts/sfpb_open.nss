...
void main()
{
    ...
    object oStorer = RetrieveCampaignObject(sModName, DATABASE_ITEM + sID + GetLocalString(OBJECT_SELF, "Town"), lLoc);
    DeleteCampaignVariable(sModName, DATABASE_ITEM + sID + GetLocalString(OBJECT_SELF, "Town"));
