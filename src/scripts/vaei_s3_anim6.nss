//::///////////////////////////////////////////////
//:: [Additional Animations: Animation 6]
//:: [vaei_s3_anim6.nss]
//:: Copyright (c) 2005 Aria Carina Velasco
//:://////////////////////////////////////////////
/*
   Plays Custom Looping Animation 6.
*/
...
void main()
{
    ...
    */
    ...
    int iAnimIndex = ANIMATION_LOOPING_CUSTOM6;
    int iCustomAnimScripts = GetLocalInt(GetModule(), "iCustomAnimBehaviour");

    float fAnimSpeed = GetLocalFloat(oPC, "fAddnAnim_Speed_6");
        if (fAnimSpeed == 0.0) fAnimSpeed = ADDNANIM_DEFAULT_SPEED_6;
    float fAnimDuration = GetLocalFloat(oPC, "fAddnAnim_Duration_6");
        if (fAnimDuration == 0.0) fAnimDuration = ADDNANIM_DEFAULT_DURATION_6;

    /* Main anim playing code begins here. */

    if (iCustomAnimScripts)
        ExecuteScript("vaei_s3_cstanm6", oPC);
    else
