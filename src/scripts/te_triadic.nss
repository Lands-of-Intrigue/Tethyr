...
//              if (((nPalLevel >= 3)&&(nAssLevel >=3))&&GetHasFeat(1354,oPC) == TRUE)
                ...
                {
                    SendMessageToPC(oPC, "You feel the power of the Triad surge through your sword.");
                    // Your code goes here
                   ...
                   IPSafeAddItemProperty(oItem, ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_DIVINE,IP_CONST_DAMAGEBONUS_1d4), 0.0, X2_IP_ADDPROP_POLICY_KEEP_EXISTING,TRUE);
                }
                break;
