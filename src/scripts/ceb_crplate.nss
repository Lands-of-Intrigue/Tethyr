...
object oItem=CreateItemOnObject("te_cebcraft015", oPC);
...
SetLocalInt(oItem, "Days", 8+nDayMod);
SetLocalInt(oItem, "Date", GetCalendarDay());
SendMessageToPC(oPC, "You have begun working on your item.  It will take " + IntToString(8+nDayMod) + " days to complete your item.");
}
