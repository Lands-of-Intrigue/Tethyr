...
// -----------------------------------------------------------------------------
// Georg, 2003-06-12
// Create a new playermadeopotionbject with properties matching nSpellID and return it
// -----------------------------------------------------------------------------
object CICraftBrewPotion(object oCreator, int nSpellID )
{
...
int CICraftCheckBrewPotion(object oSpellTarget, object oCaster)
{
    ...
    SendMessageToPC(oCaster,"Brew Potion is now handled by the KON Crafting system.");
    return FALSE;
    /*
    // -------------------------------------------------------------------------
