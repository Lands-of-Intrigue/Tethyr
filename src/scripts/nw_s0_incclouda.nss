...
void main()
{
   ...
   // effect eSpeed = EffectMovementSpeedDecrease(50);
    ...
    if (spellsIsTarget(oTarget, SPELL_TARGET_STANDARDHOSTILE, GetAreaOfEffectCreator()))
    {
        ...
        if(!MyResistSpell(GetAreaOfEffectCreator(), oTarget, fDelay)|| GetTag(oTarget) == "te_gol_iron")
        {
            ...
            nDamage = GetReflexAdjustedDamage(nDamage, oTarget, TE_GetSpellSaveDC(OBJECT_SELF,GetSpellId(),GetLastSpellCastClass()), SAVING_THROW_TYPE_FIRE, GetAreaOfEffectCreator());
