...
// End of Spell Cast Hook
    ...
    effect eFast = EffectMovementSpeedIncrease(33);
    effect eLink = EffectLinkEffects(eFast, eDur);
    eLink = EffectLinkEffects(EffectVisualEffect(1242),eLink);
    eLink = EffectLinkEffects(EffectACIncrease(1,AC_DODGE_BONUS,AC_VS_DAMAGE_TYPE_ALL),eLink);
    ...
    RemoveEffectsFromSpell(oTarget, 1037);
