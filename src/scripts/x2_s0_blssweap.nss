...
void AddBlessEffectToWeapon(object oTarget, float fDuration)
{
   ...
   IPSafeAddItemProperty(oTarget, ItemPropertyDamageBonusVsAlign(IP_CONST_ALIGNMENTGROUP_EVIL,IP_CONST_DAMAGETYPE_DIVINE, IP_CONST_DAMAGEBONUS_1d6), fDuration,X2_IP_ADDPROP_POLICY_REPLACE_EXISTING );
...
void main()
{
    ...
    */
    ...
    int nDuration = 1 * TE_GetCasterLevel(OBJECT_SELF,GetLastSpellCastClass());
