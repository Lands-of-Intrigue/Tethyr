...
void main()
{
    ...
    {
        if(!MyResistSpell( GetAreaOfEffectCreator(),oTarget) &&!MySavingThrow(SAVING_THROW_FORT, oTarget, TE_GetSpellSaveDC(OBJECT_SELF,GetSpellId(),GetLastSpellCastClass())))
        {
