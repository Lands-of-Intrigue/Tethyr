//:://////////////////////////////////////////////////
//:: Spellplague's Shadow Blast Evocation
//:: SP_Shadow_Blast
//:: Based on David Novotny's Spellfire Blast Evocation
//:///////////////////////////////////////////////////
...
void main()
{
    ...
    effect eRay1 = EffectBeam(211, OBJECT_SELF, BODY_NODE_HAND);
    effect eRay2 = EffectBeam(211, OBJECT_SELF, BODY_NODE_HAND, TRUE);
    effect eVis1 = EffectVisualEffect(479);
    int nDamF;
    int nDamM;
    effect eDamF;
    effect eDamM;
    ...
    if (nMana >= 1)
    {
        ...
        if (nTouch > 0)
        {
            ...
            eDamF = EffectDamage(nDamF, DAMAGE_TYPE_COLD);
    ...
    else
    {
        ...
        ApplyEffectToObject(DURATION_TYPE_INSTANT,EffectDamage(d4(nCasterLvl),DAMAGE_TYPE_COLD),oPC);
