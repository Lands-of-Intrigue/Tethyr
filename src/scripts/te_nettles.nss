    ...
    switch (nEvent)
        {
            case X2_ITEM_EVENT_EQUIP:
                ...
                nPalLevel = GetLevelByClass(CLASS_TYPE_ASSASSIN,oPC);
                nAssLevel = GetLevelByClass(CLASS_TYPE_RANGER,oPC);


                if (nPalLevel >= 1)
                {
                    SendMessageToPC(oPC, "You can feel your killing intent focus when you hold this weapon.");
                    // Your code goes here
                    ...
                    IPSafeAddItemProperty(oItem, ItemPropertyOnHitProps(IP_CONST_ONHIT_ITEMPOISON,IP_CONST_ONHIT_SAVEDC_20,IP_CONST_POISON_1D2_STRDAMAGE), 0.0, X2_IP_ADDPROP_POLICY_KEEP_EXISTING,TRUE);
                  }
                break;
