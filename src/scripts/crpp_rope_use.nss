...
void Climb()
{
    ...
    int nDC = 10 + nWeight - nStr - nRogue;
    if(nDC < 1) nDC = 1;
    ...
    switch(nClimb)
    {
        ...
        if(d20() >= nDC)
        {
            ...
            object oClimb = GetLocalObject(oRope, "ROPE");
        ...
        {
            DelayCommand(3.0, FloatingTextStringOnCreature("Your strength fails you as you attempt the climb.", oPC, FALSE));
        ...
        case 2:
        FloatingTextStringOnCreature("You must recoup some strength before attempting the climb again.", oPC, FALSE);
        return;
    }
}
