...
// End of Spell Cast Hook
    ...
    effect eArmor = EffectACIncrease(4, AC_SHIELD_ENCHANTMENT_BONUS); // Copy paste this line into the existing script
    ...
    int nDuration = TE_GetCasterLevel(OBJECT_SELF,GetLastSpellCastClass()); // * Duration 1 turn
