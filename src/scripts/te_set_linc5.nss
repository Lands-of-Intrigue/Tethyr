void main()
{
    ...
    if(nLockDC < 0)
    {
        SetCampaignInt("Housing",sUnique+"Lock",0);
        SetCampaignInt("Housing",sUnique+"Base",((0+nDoorDC)*5)+50);
    }
    else if (nLockDC > 30)
    {
        SetCampaignInt("Housing",sUnique+"Lock",30);
        SetCampaignInt("Housing",sUnique+"Base",((30+nDoorDC)*5)+50);
    }
    else
    {
        SetCampaignInt("Housing",sUnique+"Lock",nLockDC);
