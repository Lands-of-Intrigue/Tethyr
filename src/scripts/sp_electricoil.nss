...
void AddElectricalEffectToWeapon(object oTarget, float fDuration)
{
...
void main()
{
    ...
    {
        DoGrenade(d8(1),d4(1)+1, VFX_IMP_LIGHTNING_M, VFX_FNF_ELECTRIC_EXPLOSION,DAMAGE_TYPE_ELECTRICAL,RADIUS_SIZE_LARGE, OBJECT_TYPE_CREATURE | OBJECT_TYPE_DOOR | OBJECT_TYPE_PLACEABLE);
    }
}
