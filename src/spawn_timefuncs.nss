...
// Get the current time (elapsed since the Epoch) in real seconds - [File: spawn_timefuncs]
int GetCurrentRealSeconds();
// Convert a calendar (game) time to real seconds - [File: spawn_timefuncs]
int CalendarToRealSeconds(int year, int month, int day, int hour, int minute,
    int second);
// Returns number of real seconds in the # of specified (game) years - [File: spawn_timefuncs]
int YearsToRealSeconds(int years);
// Returns number of real seconds in the # of specified (game) months - [File: spawn_timefuncs]
int MonthsToRealSeconds(int months);
// Returns number of real seconds in the # of specified (game) days - [File: spawn_timefuncs]
int DaysToRealSeconds(int days);
// Returns number of real seconds in the # of specified (game) hours - [File: spawn_timefuncs]
