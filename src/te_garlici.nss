...
void main()
{
    ...
    // * Note that this event fires PCs only
    {
        ...
        {
            ApplyEffectToObject(DURATION_TYPE_TEMPORARY,EffectSavingThrowIncrease(SAVING_THROW_FORT,2,SAVING_THROW_TYPE_DISEASE),oTarget,TurnsToSeconds(1));
            ...
            SendMessageToPC(oTarget,"You feel a sense of satisfaction as you consume a clove of garlic.");
        }
        else
        {
