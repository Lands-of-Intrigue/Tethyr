...
void main()
{
    ...
    string sArea1 = GetTag(GetArea(oPC));
    object oTarget = GetSpellTargetObject();
    string sArea2 = GetTag(GetArea(oTarget));
    int nBonus = 4;
    ...
    if(sArea1 != GetTag(GetArea(oTarget)))
    {
        FloatingTextStringOnCreature("You cannot aid someone else using this ability", oPC, FALSE);
        return;
    }
