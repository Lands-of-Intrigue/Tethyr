//8-13-18 1015 modified to be set TRUE for copy vars.
...
{
    object oCopy = CopyItem(oItem, oTargetInventory, TRUE);
...
{
    object oCopy = CopyItemAndModify(oItem, nType, nIndex, nNewValue, TRUE);
...
object MK_MatchItem(object oDest, object oSource, int nType, int nIndex)
{
    ...
    object oNew = MK_CopyItemAndModify(oDest, nType, nIndex, nValue,TRUE);
    DestroyObject(oDest);
    return oNew;
}
