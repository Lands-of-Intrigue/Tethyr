...
void main()
{
    ...
    NWNX_Creature_AddFeat(oTarget,1137);
    SetLocalInt(GetItemPossessedBy(oTarget,"PC_Date_Object"),"11",1);

    SendMessageToPC(oPC, "This person is now assigned to the Abyssal Faction.");
