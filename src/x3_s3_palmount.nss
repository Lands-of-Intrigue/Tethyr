...
void main()
{
    SendMessageToPC(OBJECT_SELF,"Function depreciated, please use Call for Help tool.");
    /*
    ...
    if(nPiety <= 60)
    {
        SendMessageToPC(oPC,"Your faithful mount does not come when it is called. Your deeds are not in accordance with your vows.");
        return;
    }
