...
object oItem=CreateItemOnObject("te_cebcraft017", oPC);
...
SetLocalInt(oItem, "Days", 4+nDayMod);
SetLocalInt(oItem, "Date", GetCalendarDay());
SendMessageToPC(oPC, "You have begun working on your item.  It will take " + IntToString(4+nDayMod) + " days to complete your item.");
}
