    ...
    switch (nEvent)
        {
            case X2_ITEM_EVENT_EQUIP:
                ...
                nAssLevel = GetLevelByClass(CLASS_TYPE_PALADIN,oPC);


                if ((nPalLevel >= 3||nAssLevel >= 3)&&GetHasFeat(1359,oPC) == TRUE)
                {
                    ...
                    IPSafeAddItemProperty(oItem, ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_ACID,IP_CONST_DAMAGEBONUS_2), 0.0, X2_IP_ADDPROP_POLICY_KEEP_EXISTING,TRUE);
