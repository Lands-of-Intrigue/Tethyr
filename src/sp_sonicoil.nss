...
void main()
{
        ...
        if(nItem == TRUE)
        {
            if(GetIsObjectValid(oMyWeapon))
            {
                ...
                if (nDuration > 0)
                {
                    ...
                    itemproperty iIp = ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_SONIC, IP_CONST_DAMAGEBONUS_1d6);
    ...
    {
        DoGrenade(d8(1),d4(1)+1, VFX_IMP_SONIC, VFX_FNF_SOUND_BURST, DAMAGE_TYPE_SONIC, RADIUS_SIZE_LARGE, OBJECT_TYPE_CREATURE | OBJECT_TYPE_DOOR | OBJECT_TYPE_PLACEABLE);
    }
}
